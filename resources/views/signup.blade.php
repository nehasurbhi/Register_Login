        ...
        <div class="signup-form">
         <div class="text-center my-3 mx-auto">
          ...
          <form class=" " action="#" method="POST">
            <div class="mt-2">
              <label for="email" class="block text-sm font-medium leading-6 text-gray-400">Usernames</label>
            ...
            <div class="my-2">
                <label for="password" class="block text-sm font-medium leading-6 text-gray-400"> Confirm Password</label>
              
                <input id="confirmpPassword" name="confirmpPassword" type="confirmpPassword" autocomplete="current-password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green sm:text-sm sm:leading-6"> 
            </div>

            <!-- <div class="flex items-center justify-between my-4">
               
                <div class="flex items-center ">
                <input type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-green check" id="hs-default-checkbox">
            ...
            <div class="my-5">
              <button type="submit" class="flex mt-5 w-full justify-center rounded-md bg-green px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-green-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700">Sign Up</button>
            </div>
          </form>

          <p class=" text-center text-sm text-gray-600 font-semibold">
          Already hav an account ?
            <a href="#" class="font-semibold leading-6 text-green hover:text-green-800">Sign In</a>
          </p>
        </div>
